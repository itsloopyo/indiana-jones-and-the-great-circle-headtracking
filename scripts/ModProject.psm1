...
$script:ModName = 'GreatCircleHeadTracking'
$script:ModId = 'indiana-jones-and-the-great-circle'
$script:DisplayName = 'Indiana Jones and the Great Circle'
